public class Main {
    public static void main(String[] args) {
        ...
        Name n1 = new Name();
        Name n2 = new Name("Eduardo");
        Name n3 = new Name("Christian","Buenafe");
        Name n4 = new Name("Miguel","Mellina","Cortes");
        Name n5 = new Name();
        ...
        n5.setName("Buenafe", "Regine Christian", "Lequit");

        System.out.println();

        Date d1= new Date();
        Date d2 = new Date(2003);
        Date d3 = new Date(10, 2004);
        Date d4 = new Date(07,14,2003);
        Date d5 = new Date();
